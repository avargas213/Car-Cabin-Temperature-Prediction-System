...
Controlled testing using a repeatable heating setup to evaluate algorithm behavior.

Vehicle testing to evaluate prediction performance under more realistic cabin conditions.
...
Standard deviation of initial error
...
Standard deviation of final error
