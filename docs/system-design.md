...
Raw experimental sample

0.5 second

Initial local k interval
...
connects to the ESP32 at 115200 baud,

waits for the start message,

records raw samples,

stores initial model predictions,

records adaptive updates,

receives the actual completion time,

calculates initial and final prediction errors,

saves CSV results,

closes the connection after the completed test.
